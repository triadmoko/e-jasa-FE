...
export default function Register() {
  return (
    <>
      ...
      <img class="object-cover object-right-top h-96 w-auto absolute top-16 right-0 scale-96" src="assets/register_bg_2.png" alt="bg"/>
      <img class="object-cover object-right-top h-96 w-auto absolute top-16 left-0 scale-96" src="assets/register_bg_2.png" alt="bg"/>
      <img class="object-cover object-right-top h-auto w-96 absolute bottom-12 right-96 scale-96" src="assets/register_bg_2.png" alt="bg"/>
