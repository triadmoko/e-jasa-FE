  ...
  return (
    <section>
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 mb-20">
        <div class="p-8 bg-dark-800 dark:bg-gray-800 rounded-lg shadow">
              ...
              <div class="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between">
                <a href="./#">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    class="text-xl hover:text-blue-700 dark:hover:text-white transition-colors duration-200"
                ...
                <a href="./#">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    class="text-xl hover:text-cyan-500 dark:hover:text-white transition-colors duration-200"
                    viewBox="0 0 1792 1792"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                < a href="./#">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    class="text-xl hover:text-pink-400 dark:hover:text-white transition-colors duration-200"
                    viewBox="0 0 24 24"
                ...
                < a href="./#">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    class="text-xl hover:text-green-400 dark:hover:text-white transition-colors duration-200"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/1999/xlink"
                  >
