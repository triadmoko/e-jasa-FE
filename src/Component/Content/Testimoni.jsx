...
<div class="bg-white dark:bg-gray-800 w-full rounded-lg p-4 mb-6 shadow sm:inline-block">
    <div class="flex items-start text-left animate__animated animate__slideInDown animate__fast">
        ...
        <div class="ml-6">
            ...
            <div class="mt-3">
                <p class="mt-1 max-w-xs dark:text-white">
                    Pelayanan di ITes sangat memuaskan, para anggota ramah dan sabar melayani permintaan dari pelanggan.
                </p>
            </div>
        </div>
            <div class="inline-block relative">
    ...
    <div class="h-24"></div>
    <div class="flex items-start text-left animate__animated animate__fadeInDown animate__delay-0.5s">
        <div class="flex-shrink-0">
            <div class="inline-block relative">
                <a href="./#" class="block relative">
                    <img alt="profil"
