...
const Testi = () => {
  return (
    <div className="bg-white dark:bg-gray-800 w-full rounded-lg p-4 mb-6 shadow sm:inline-block">
      <div className="flex items-start text-left animate__animated animate__slideInDown animate__fast">
        ...
        <div className="ml-6">
          ...
          <div className="mt-3">
            <p className="mt-1 max-w-xs dark:text-white">
              Pelayanan di ITes sangat memuaskan, para anggota ramah dan sabar
              melayani permintaan dari pelanggan.
            </p>
          </div>
        </div>
        <div className="inline-block relative">
      ...
      <div className="flex items-start text-left animate__animated animate__fadeInDown animate__delay-0.5s">
        <div className="flex-shrink-0">
          <div className="inline-block relative">
            <a href="./#" className="block relative">
              <img
